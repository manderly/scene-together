...
const Form: React.FC<IForm> = ({ searchType }) => {  // functional component 
  ...
  function loadTestData() {
    ...
    if (searchType === searchTypes.byActors) {
      ...
      sampleData = '[{"id":1330,"name":"Dominic Monaghan","characterName1":"Charlie Pace","characterName2":"Meriadoc \\"Merry\\" Brandybuck","showName1":"Lost","showName2":"The Lord of the Rings: The Fellowship of the Ring"}]';
    }
